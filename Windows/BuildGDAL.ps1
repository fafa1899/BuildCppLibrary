param( 
    [string]$SourceAddress = "https://github.com/OSGeo/gdal/releases/download/v3.8.5/gdal385.zip",
    [string]$SourceZipPath = "../Source/gdal385.zip",
    [string]$SourceLocalPath = "./gdal-3.8.5",
...
try {
    # 配置CMake  
    cmake .. -G "$Generator" -A x64 -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_PREFIX_PATH="$env:GISBasic" -DCMAKE_INSTALL_PREFIX="$InstallDir" -DGDAL_USE_CURL=OFF -DBUILD_TESTING=OFF -DGDAL_USE_OPENSSL=OFF -DGDAL_USE_SPATIALITE=OFF -DGDAL_USE_MSSQL_NCLI=OFF
